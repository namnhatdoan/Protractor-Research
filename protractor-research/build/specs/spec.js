...
describe('Protractor Demo App', function () {
    ...
    beforeEach(() => {
        ...
        protractor_1.element(protractor_1.by.xpath('//*[@id="Feedback_CreatedDate"]/following-sibling::img')).click();
    });
    it('check', function () {
        let dpk = new dpkHelper(protractor_1.element(protractor_1.by.id('ui-datepicker-div')), null);
